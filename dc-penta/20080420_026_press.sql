...
INSERT INTO auth.permission (permission) values ('press_login');
INSERT INTO auth.role (role, rank) values ('press_admin', 10);
INSERT INTO auth.role_permission (role, permission) values ('press_admin', 'press_login');
