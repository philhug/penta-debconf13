...
CREATE TABLE debconf.dc_person_data_frozen AS
...
FROM
	person p
	JOIN public.conference_person USING (person_id)
...
WHERE public.conference_person.conference_id = 2 AND dccp.conference_id = 2
;
